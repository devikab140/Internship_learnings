...
# #cross-98.9898 , no scale=1 , with scale =1
...
#cross=97 , xg_no scale=95 , with scale=95
...
# #no scale-92, cv=88 ,scaled no change
...
# print("Accuracy",accuracy_score(y_test, y_pred))
# print(classification_report(y_test, y_pred))
# # with scale -72 , cv=74 ,without no change
...
# print("Accuracy",accuracy_score(y_test, y_pred))
# print(classification_report(y_test, y_pred))
# #scaled-82 , cv=83 ,no scale no change
...
# print("Accuracy",accuracy_score(y_test, y_pred))
# print(classification_report(y_test, y_pred))
# #with scale cv=95 , acc=1  without no change
...
# print("Accuracy",accuracy_score(y_test, y_pred))
# print(classification_report(y_test, y_pred))
# #with scale cv=87 ,acc=88 ... without no change
...
# print("Accuracy",accuracy_score(y_test, y_pred))
# print(classification_report(y_test, y_pred))
# #scale cv=88 , acc=86 without no change
...
# model=XGBClassifier()
# skf=StratifiedKFold(n_splits=5)
# cv_scores=cross_val_score(model,X_vectorized, y_encoded, cv=skf)
# print("cross_val_score results:", cv_scores)
# print("cross_val_score mean:", cv_scores.mean())
